...
class CaliforniaFingerprint {
    ...
    static forceEnglishConfig(config = {}) {
        return {
            ...config,
    ...
    static getAcceptLanguageHeader() {
    ...
    static generateRandomCaliforniaFingerprint(options = {}) {
        ...
        return this.forceEnglishConfig({
            ...baseConfig,
    ...
    static validateFingerprintConsistency(config = {}, options = this.getPlaywrightOptions(config)) {
        config = this.forceEnglishConfig(config);
        const issues = [];
        ...
        if (headers['Accept-Language'] !== this.getAcceptLanguageHeader()) {
            issues.push('Accept-Language does not match English baseline');
        }
        if (options.locale !== this.ENGLISH_LOCALE) {
            issues.push('locale does not match English baseline');
        }
    ...
    static async createCaliforniaContext(browser, customConfig = {}) {
        ...
        const config = this.forceEnglishConfig({
